...
import com.example.backendtodoappapi.user.request.ChangePasswordRequest;
...
public class UserService {
    ...
    public User findUserByIdUserObject(long userId){
        return userRepository.findById(userId)
                .orElseThrow(() -> new EntityNotFoundException("User not found with ID: " + userId));
    }
      public List<UserResponse> getAllUserByRoleType(Role role){
